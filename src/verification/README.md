...
| Setup | 02.04        | Implemented     | Done (with negative)    |
| Setup | 02.05        | Implemented     | Done (with negative)    |
| Setup | 03.01        | Implemented     | Done (with negative)    |
| Setup | 03.02        | Implemented     | Done (with negative)    |
| Setup | 03.03        | Implemented     | Done (with negative)    |
| Setup | 03.04        | Implemented     | Done (with negative)    |
| Setup | 03.05        | Implemented     | Done (with negative)    |
| Setup | 03.06        | Implemented     | Done (with negative)    |
...
| Setup | 03.13        | Implemented     | Done (with negative)    |
...
| Tally | 08.03        | Implemented     | Done (with negative)    |
| Tally | 08.04        | Implemented     | Done (with negative)    |
| Tally | 08.05        | Implemented     | Done (with negative)    |
| Tally | 08.06        | Implemented     | Done (with negative)    |
| Tally | 08.07        | Implemented     | Done (with negative)    |
| Tally | 08.08        | Implemented     | Done (with negative)    |
| Tally | 08.09        | Implemented     | Done (with negative)    |
| Tally | 08.10        | Implemented     | Done (with negative)    |
