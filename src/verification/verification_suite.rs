...
mod test {
    ...
    const EXPECTED_IMPL_SETUP_VERIF: usize = 23;
    const IMPL_SETUP_TESTS: &[&str] = &[
        "01.01", "02.01", "02.03", "02.04", "02.05", "02.06", "03.01", "03.02", "03.03", "03.04",
        "03.05", "03.06", "03.07", "03.08", "03.09", "03.13", "03.15", "04.01", "05.01", "05.02",
        "05.03", "05.04", "05.21",
    ];
    const MISSING_SETUP_TESTS: &[&str] = &[
        "02.02", "02.07", "02.08", "03.10", "03.11", "03.12", "03.14", "05.22",
    ];
